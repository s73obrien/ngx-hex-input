...
export class CdkVirtualScrollViewport extends CdkScrollable implements OnInit, OnDestroy {
   ...
   */
  private _renderedContentTransformSubject = new Subject<string>();
  public onRenderedContentTransformChanged = this._renderedContentTransformSubject.asObservable();
  private __transform: string;
  private set _renderedContentTransform(value: string) {
    this.__transform = value;
    this._renderedContentTransformSubject.next(value);
  }

  private get _renderedContentTransform(): string {
